...
public class Exercise_31_05Client extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Exercise_31_05Client");
        ...
        btSubmit.setOnAction(e -> {
            try {
                ...
                output.flush();
                taStatus.appendText("Annual interest rate: " + loan.getAnnualInterestRate() + "\n" + 
                            "Number of Years: " + loan.getNumberOfYears() + "\n" + "Loan amount: " + loan.getLoanAmount() + "\n");
                
                loan = (Loan)input.readObject();
                taStatus.appendText("monthlyPayment: " + loan.getMonthlyPayment() + "\n" + 
